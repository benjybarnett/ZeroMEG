function bb_fsl_maths(cfg)
% Matlab wrapper for fslmaths
%
% cfg.inputfile     = filename of input image
% cfg.outputfile    = filename of output image
% cfg.operations    = string containing relevant operations (see below)
%
% Binary operations:
...
fslCommand = ['fslmaths ' inputfile ' ' operations ' ' outputfile];
