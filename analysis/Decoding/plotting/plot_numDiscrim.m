...
for subj =1:length(subjects)
    ...
    arabic_acc_0 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_arabic_0.mat'));
    dot_acc_0 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_dot_0.mat'));
    arabic_acc_1 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_arabic_1.mat'));
    dot_acc_1 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_dot_1.mat'));
    arabic_acc_2 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_arabic_2.mat'));
    dot_acc_2 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_dot_2.mat'));
    arabic_acc_3 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_arabic_3.mat'));
    dot_acc_3 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_dot_3.mat'));
    arabic_acc_4 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_arabic_4.mat'));
    dot_acc_4 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_dot_4.mat'));
    arabic_acc_5 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_arabic_5.mat'));
    dot_acc_5 = load(fullfile(cfg0.root,cfg0.output_path,subject,'within_dot_5.mat'));
