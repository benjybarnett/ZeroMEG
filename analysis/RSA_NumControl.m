function  RSA_NumControl(cfg0,subject)
    ...
    %point. Test the control analysis for Numerical Task.
   ...
   stnd_zero_idx = trial_info(:,3) == 1 & trial_info(:,14) == 0 & trial_info(:,13) == 1;
   stnd_one_idx = trial_info(:,3) == 1 & trial_info(:,14) == 1 & trial_info(:,13) == 1;
   stnd_two_idx = trial_info(:,3) == 1 & trial_info(:,14) == 2 & trial_info(:,13) == 1;
   stnd_three_idx = trial_info(:,3) == 1 & trial_info(:,14) == 3 & trial_info(:,13) == 1;
   ctrl_zero_idx = trial_info(:,3) == 1 & trial_info(:,14) == 0 & trial_info(:,13) == 2;
   ctrl_one_idx = trial_info(:,3) == 1 & trial_info(:,14) == 1 & trial_info(:,13) == 2;
   ctrl_two_idx = trial_info(:,3) == 1 & trial_info(:,14) == 2 & trial_info(:,13) == 2;
   ctrl_three_idx = trial_info(:,3) == 1 & trial_info(:,14) == 3 & trial_info(:,13) == 2;
    ...
    des_mat(ctrl_zero_idx, 5)           = 1;
    des_mat(ctrl_one_idx, 6)            = 1;
    des_mat(ctrl_two_idx, 7)            = 1;
    des_mat(ctrl_three_idx, 8)          = 1;
